...
public class CellTracker implements PlugInFilter{
	...
	private boolean showDialog() {
		...
		gd.addNumericField("value11", 0.00, 2);
		gd.addStringField("name22", "John");
	...
	public static void main(String[] args) {
		...
		ImagePlus image = IJ.openImage("C:/Tokyo/data/170628-c5590829xy1hf_C0002_T0001.tif");
		image.show();
