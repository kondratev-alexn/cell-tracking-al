...
public class ComponentStateLink {
	...
	public boolean checkRevertedStates(ImageComponentsAnalysis comp1, int i1, ImageComponentsAnalysis comp2, int i2) {
		return comp1.getComponentState(i1) == to && comp2.getComponentState(i2) == from;
	}
}
