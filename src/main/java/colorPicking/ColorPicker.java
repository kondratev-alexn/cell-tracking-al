...
public class ColorPicker {
	...
	// return String of the next color in palette. Don't use black which is index 0
	public String nextColorAsString() {
		return indexСolors[++colorIndex];
	}
	
	public Color nextColor() {
		return Color.decode(indexСolors[++colorIndex]);
	}
	
	public static Color color(int index) {
		return Color.decode(indexСolors[index]);
	}
	
	// list of 1000+ colors, the next one generated as the farthest in lab space (something something)
	public static final String[] indexСolors = new String[] {
